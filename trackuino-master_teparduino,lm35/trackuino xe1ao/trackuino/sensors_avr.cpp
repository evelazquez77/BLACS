...
// OJO: PIN 10 controla Back Light de LCD  23/06/15
  ...
  switch(TEMP_UNIT) {
	...
	//return adc;        
	return ((4.6 * adc * 100.0) / 1024) + CALIBRATION_VAL;
    case 2: // K
      // C + 273 = K
